function ASL_T1ROI_CBFaverage(mprpath,mprname,acbffile,rcbffile,outpath)
...
roi_stats_file = [mprpath filesep mprname '_' atlas_ver '_stats.txt'];
...
P0 = spm_select('FPList',mprpath,['^' mprname '.*\_' atlas_ver '.img']);
roimaskfile = P0(1,:);
...
for tt = 1:length(roi_lists_info)-1
    ...
    outVol = V0;
    outVol.fname = [outpath filesep mprname '_' num2str(seg_num) 'segments.img'];
